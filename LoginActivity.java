...
//                            Toast.makeText(getApplicationContext(), "em", 1000).show();
                        ...
                        asyncPOST = new AsyncPOST(nameValuePairs_login, LoginActivity.this, common.Configg.MAIN_URL + common.Configg.USER_LOGIN, LoginActivity.this);
                        asyncPOST.execute();
                    } else {
    ...
    public void processFinish(String output) {
        ...
        try {
            ...
            if (jsonObject.getString("success").equals("1")) {
                ...
                intent.putExtra("pid",jsonObject.getJSONArray("patient_list").getJSONObject(0).getString("mid"));
                startActivity(intent);
